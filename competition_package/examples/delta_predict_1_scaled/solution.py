...
class PredictionModel(nn.Module):
    def __init__(self):
        ...
        # shrink factor for predicted deltas (tune 0.3–0.8)
    ...
    def predict(self, dp: DataPoint):
        ...
        model outputs DELTA, but scorer expects RAW → return raw + scaled_delta
        """
        ...
        # ↓ shrink amplitude of delta
        pred_raw = raw + self.delta_scale * pred_delta
